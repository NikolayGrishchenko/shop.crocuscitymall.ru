...
global $arrCatalogElementFilter;
$arrCatalogElementFilter = [
	'!ID' => $elementId,
];
...
$APPLICATION->IncludeComponent(
	...
	array(
		...
		"PRODUCT_QUANTITY_VARIABLE" => $arParams["PRODUCT_QUANTITY_VARIABLE"],
		"PRODUCT_PROPS_VARIABLE" => $arParams["PRODUCT_PROPS_VARIABLE"],
		"FILTER_NAME" => 'arrCatalogElementFilter',
		"CACHE_TYPE" => $arParams["CACHE_TYPE"],
		"CACHE_TIME" => $arParams["CACHE_TIME"],
...
<?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"CACHE_TIME" => "3600",
		"CACHE_TYPE" => "A",
		"CART_PROPERTIES_2" => array("BRAND","SEX",""),
		"CART_PROPERTIES_3" => array("COLOR",""),
		"CONVERT_CURRENCY" => "N",
		"DEPTH" => "2",
		"DISPLAY_COMPARE" => "N",
		...
		"OFFER_TREE_PROPS_3" => array("COLOR"),
		...
		"PROPERTY_CODE_2" => array("TITLE","KEYWORDS","META_DESCRIPTION","BLOG_POST_ID","VENDOR_CODE","BRAND","IMAGE","BLOG_COMMENTS_CNT","MATERIAL","SEX","POPULARITY","COMPOSITION","OLD_PRICE","COUNTRY",""),
		"PROPERTY_CODE_3" => array("CML2_LINK","ARTNUMBER","SIZE","COLOR",""),
